        ...
        <div className="row top">
                        ...
                        {cartItems.map(item=>
                        {
                            return(<li key={item.product}>
                                <div className="row">
                                     ...
                                     <div>${item.price}</div>
                                     <div>
                                         <button className="cart" type="button" onClick={(e)=>removeFromCartHandler(item.product)}>Delete</button>
                                     </div>
                                </div>
                            </li>)
                         })
            ...
            <div className="col-1">
                <div className="card card-body">
                    <ul>
                        <li>
                            <h2>Subtotal: ({cartItems.reduce((a,c)=>a + c.qty, 0)} items) :${cartItems.reduce((a,c)=>a + c.qty * c.price, 0)}
                            </h2>
                        </li>
                        <li>
